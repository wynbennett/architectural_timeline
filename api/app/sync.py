    ...
    with SrcSession() as src, DstSession() as dst:
        ...
        for src_repo in repos:
            ...
            for src_tag in src_repo.tags:
                ...
                dst.add(Graph(repo_id=repo.id, tag_id=tag.id, tier1=g.tier1, tier2=g.tier2, tier3=g.tier3, change_summary=g.change_summary, model=g.model, prompt_version=g.prompt_version, generated_at=g.generated_at))
